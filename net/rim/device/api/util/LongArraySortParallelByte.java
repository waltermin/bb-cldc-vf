...
final class LongArraySortParallelByte {
   ...
   private static final boolean exchange(long[] var0, byte[] var1, int var2, int var3) {
      long var4 = var0[var2];
      long var6 = var0[var3];
      if (var4 > var6) {
         var0[var2] = var6;
   ...
   private static final void mergeSort(long[] var0, long[] var1, byte[] var2, byte[] var3, int var4, int var5) {
      throw new RuntimeException("cod2jar: stack imbalance");
   }
}
