...
final class HashtableIntEnumerator implements IntEnumeration {
   ...
   HashtableIntEnumerator(int[] var1, Object[] var2, Object var3) {
      this.resetEnumeration(var1, var2, var3);
   }

   final void resetEnumeration(int[] var1, Object[] var2, Object var3) {
      this._table = var1;
      this._occupied = var2;
      this._empty = var3;
      this._index = 0;
