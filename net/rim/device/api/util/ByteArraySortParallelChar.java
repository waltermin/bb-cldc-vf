...
final class ByteArraySortParallelChar {
   ...
   private static final boolean exchange(byte[] var0, char[] var1, int var2, int var3) {
      byte var4 = var0[var2];
      byte var5 = var0[var3];
      if (var4 > var5) {
         var0[var2] = var5;
   ...
   private static final void mergeSort(byte[] var0, byte[] var1, char[] var2, char[] var3, int var4, int var5) {
      switch (var5) {
         case -1:
            int var6 = var5 + 1 >> 1;
