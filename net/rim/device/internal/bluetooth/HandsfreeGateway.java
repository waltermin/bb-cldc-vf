...
public final class HandsfreeGateway {
   ...
   public static final void addListener(Application var0, HandsfreeGatewayListener var1) {
      throw new RuntimeException("cod2jar: exception table");
   }

   public static final void removeListener(Application var0, HandsfreeGatewayListener var1) {
      var0.removeListener(40, var1);
   }
}
